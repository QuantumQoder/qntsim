...
def alice_measurement():
    ...
    key_0=qm_alice.new([complex(-1/math.sqrt(2)), complex(1/math.sqrt(2))]) # Add random state you want to create.
    ...
    # Based on the output we perform corrective measurements
    # 00 ==> no Gate
    # 01 ==> X gate
    # 10 ==> Z gate
    # 11 ==> X,Z gate
...
def bob_gates(crz,crx):
    ...
    # Here we dont measure out the circuit, instead just run the circuit to get the random state
