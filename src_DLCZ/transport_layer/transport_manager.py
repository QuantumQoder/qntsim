...
class TransportManager():
    ...
    def request(self, dest, starttime, size,endtime, priority, timeout):
        """ 
        ...
        Attributes:
        dest (str): name of destination node.
        ...
        transport_protocol_src=TransportProtocol(self.owner, dest,starttime,size,endtime,priority,timeout) #Create source protocol instance
        ...
        self.owner.send_message(dest,message)
    ...
    def received_message(self,src,msg: ProtocolMessage):
        ...
        if msg_type is ProtocolMsgType.REQ:
            ...
            transport_protocol_dest=TransportProtocol(self.owner, msg.objsrc.owner.name,msg.objsrc.starttime,msg.objsrc.endtime,msg.objsrc.size,msg.objsrc.priority,msg.objsrc.timeout)  #Creating destination protocol
...
class TransportProtocol(TransportManager):
    ...
    def __init__(self,owner , other, starttime,size,endtime,priority,timeout):
        self.owner=owner
        self.other= other
