...
class RoutingTableUpdateProtocol(NewRoutingProtocol):
    ...
    def __init__(self,owner,name):
        ...
        self.update_time=1e12  # Time interval at which this protocol will be called
        self.vlink_data={}
    ...
    def sendmessage(self):
        ...
        #List of all virtual neighbors of the node
        # print('neighborhoodlist',self.own.name,self.find_neighbors())
