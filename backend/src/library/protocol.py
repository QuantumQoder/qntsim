...
class Protocol:
    def __init__(self, messages_list:List[Dict[int, str]], usr:int=0, **kwargs) -> None:
        ...
        if usr:
            for messages in messages_list:
                ...
                returns = []
                for func in kwargs.get('functions', print("Provide all the executable functions.")):
                    returns = func(network, returns)
