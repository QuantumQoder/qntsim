...
if TYPE_CHECKING:
    ...
    from ...layers.network_layer.network_management.reservation import \
        Reservation
    from ...layers.physical_layer.components.optical_channel import (
        ClassicalChannel, QuantumChannel)
    from ...utils.message import Message
    from ...utils.protocol import StackProtocol
    from ..resource_management.memory_manager import MemoryInfo
#from ..kernel.timeline import DLCZ ,bk
from ..kernel.timeline import Timeline

if Timeline.DLCZ:
    from ...layers.physical_layer.components.DLCZ_bsm import SingleAtomBSM
    from ...layers.physical_layer.components.DLCZ_memory import (Memory,
                                                                 MemoryArray)
    print("DLCZ node")
elif Timeline.bk:
    from ...layers.physical_layer.components.bk_bsm import SingleAtomBSM
    from ...layers.physical_layer.components.bk_memory import (Memory,
                                                               MemoryArray)
    print("bk node")
...
from ...layers.network_layer.network_management.network_manager import \
    NetworkManager
from ...layers.network_layer.network_management.request import RRPMsgType
from ...layers.physical_layer.components.detector import (
    QSDetectorPolarization, QSDetectorTimeBin)
from ...layers.physical_layer.components.light_source import (LightSource,
                                                              SPDCSource2)
from ...layers.transport_layer.transport_manager import TransportManager
...
class BSMNode(Node):
    ...
    def __init__(self, name: str, timeline: "Timeline", other_nodes: List[str]) -> None:
        ...
        if Timeline.DLCZ:
            #print('DLCZ node egb')
            from ...layers.link_layer.entanglement_management.DLCZ_generation import \
                EntanglementGenerationB
        elif Timeline.bk:
            from ...layers.link_layer.entanglement_management.bk_generation import \
                EntanglementGenerationB
