...
class Event:
    ...
    def run(self) -> None:
        log.logger.debug(f"executing {self.owner}.{self.activation} with params: {self.act_params}")
        # print(f"executing {self.owner}.{self.activation} with params: {self.act_params}")
