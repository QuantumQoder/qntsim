...
from ....core.resource_management.rule_manager import Rule
from ....utils.message import Message

if Timeline.DLCZ:
    from ...link_layer.entanglement_management.DLCZ_generation import \
        EntanglementGenerationA
    from ...link_layer.entanglement_management.DLCZ_purification import BBPSSW
    from ...link_layer.entanglement_management.DLCZ_swapping import (
        EntanglementSwappingA, EntanglementSwappingB)
elif Timeline.bk:
    from ...link_layer.entanglement_management.bk_generation import EntanglementGenerationA
    from ...link_layer.entanglement_management.bk_purification import BBPSSW
    from ...link_layer.entanglement_management.bk_swapping import EntanglementSwappingA, EntanglementSwappingB
...
from ....core.resource_management.memory_manager import (MemoryInfo,
                                                         MemoryManager)
from ....core.resource_management.task_manager import (SubTask, Task,
                                                       TaskManager)
from ....core.topology.message_queue_handler import (ManagerType,
                                                     MsgRecieverType,
                                                     ProtocolType)
...
class ReservationProtocol():     #(Protocol): 
    ...
    def __init__(self,node:"Node",request:"Request",routing:"RoutingProtocol", es_success_prob = 1, es_degradation = 0.95):
