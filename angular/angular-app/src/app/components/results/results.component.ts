...
export class ResultsComponent implements OnInit, AfterViewInit {
  ...
  logs: any;
  app: string;
  constructor(private con: ConditionsService, private router: Router) {}
  ...
  ngOnInit(): void {
    ...
    this.performance.execution_time =
      this.performance.execution_time.toFixed(3);
    ...
    if (this.app_id == 1) {
      this.match = this.data.sender_basis_list.reduce(
        (match: any, x: any, i: any) => {
