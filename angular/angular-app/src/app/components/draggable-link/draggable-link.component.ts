...
@Component({
  ...
  styleUrls: ['./draggable-link.component.less']
})
export class DraggableLinkComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    function makePort(name: string, spot: any, output: any, input: any) {
  ...
  mysavedModel = document.getElementById("mySavedModel") as HTMLInputElement
  // Show the diagram's model in JSON format that the user may edit
  save() {
    this.saveDiagramProperties();  // do this first, before writing to JSON
    this.mysavedModel!.value = this.myDiagram.model.toJson();
    this.myDiagram.isModified = false;
  }
  load() {
    //this.myDiagram.model = go.Model.fromJson(this.mysavedModel!.value);
